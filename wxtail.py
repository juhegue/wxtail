...
SLEEP_TIME=0.5              # tiempo refresco de la actualización / tiempo de espera para finalizar
...
def FicDialogo(win, fichero):
    ...
    if fichero is None:
        ...
        fichero = ''
        estilo = wx.FD_MULTIPLE | wx.FD_OPEN |wx.FD_CHANGE_DIR
    else:
        msg = "Elija un fichero"
        estilo = wx.FD_OPEN |wx.FD_CHANGE_DIR
...
class TailHilo:
    ...
    def Inicia(self):
        ...
        _thread.start_new_thread(self.Corre, ())
...
class Pagina(wx.Panel):
    def __init__(self, parent, nomFichero, lineas):
        ...
        self.bloqueo = _thread.allocate_lock()

        box = wx.StaticBox(self, -1)
        bsizer = wx.StaticBoxSizer(box, wx.VERTICAL)

        bmp1 = wx.ArtProvider.GetBitmap(wx.ART_FILE_OPEN, wx.ART_OTHER, (16,16))
...
class Frame(wx.Frame):
    ...
    def CreaToolBar(self):
        self.tbID1 = wx.NewIdRef()
        self.tbID2 = wx.NewIdRef()
        self.tbID3 = wx.NewIdRef()
        self.tbID4 = wx.NewIdRef()
        self.tbID5 = wx.NewIdRef()
        self.tbID6 = wx.NewIdRef()
        self.tbID7 = wx.NewIdRef()
        ...
        bmp1 = wx.ArtProvider.GetBitmap(wx.ART_QUIT, wx.ART_OTHER, (16,16))
        self.tb.AddTool (self.tbID1, "Salir", bmp1, shortHelp="Salir")
        self.tb.AddSeparator()
        bmp2 = wx.ArtProvider.GetBitmap(wx.ART_NEW, wx.ART_OTHER, (16,16))
        self.tb.AddTool(self.tbID2, "Nuevo", bmp2, shortHelp="Nuevo")
        self.tb.AddSeparator()
        bmp3 = wx.ArtProvider.GetBitmap(wx.ART_DELETE, wx.ART_OTHER, (16,16))
        self.tb.AddTool(self.tbID3, "Cerrar todo", bmp3, shortHelp="Cerrar todo")
        bmp4 = wx.ArtProvider.GetBitmap(wx.ART_PLUS, wx.ART_OTHER, (16,16))
        self.tb.AddTool(self.tbID4, "Marca todo", bmp4, shortHelp="Marca todo")
        bmp5 = wx.ArtProvider.GetBitmap(wx.ART_REDO, wx.ART_OTHER, (16,16))
        self.tb.AddTool(self.tbID5, "Recargar todo", bmp5, shortHelp="Recargar todo")
        self.tb.AddSeparator()

        bmp6 = wx.ArtProvider.GetBitmap(wx.ART_FIND, wx.ART_OTHER, (16,16))
        self.tb.AddTool(self.tbID6, "Buscar", bmp6, shortHelp="Buscar")
        self.tb.AddSeparator()

        bmp7 = wx.ArtProvider.GetBitmap(wx.ART_FIND_AND_REPLACE, wx.ART_OTHER, (16,16))
        self.tb.AddTool(self.tbID7, "Buscar siguiente", bmp7, shortHelp="Buscar siguiente")
        self.tb.AddSeparator()
    ...
    def CreaMenu(self):
        self.menuID1 = wx.NewIdRef()
        self.menuID2 = wx.NewIdRef()
        self.menuID3 = wx.NewIdRef()
        self.menuID4 = wx.NewIdRef()
        self.menuID5 = wx.NewIdRef()
        self.menuID6 = wx.NewIdRef()
        self.menuID7 = wx.NewIdRef()
        self.menuID8 = wx.NewIdRef()
        self.menuID9 = wx.NewIdRef()
        self.menuID10 = wx.NewIdRef()
        ...
        bmp1 = wx.ArtProvider.GetBitmap(wx.ART_NEW, wx.ART_OTHER, (16,16))
        item1.SetBitmap(bmp1)
        menu.Append(item1)

        item2 = wx.MenuItem(menu, self.menuID2,"&Abrir", u"Abre fichero en la página actual")
        bmp2 = wx.ArtProvider.GetBitmap(wx.ART_FILE_OPEN, wx.ART_OTHER, (16,16))
        ...
        bmp9 = wx.ArtProvider.GetBitmap(wx.ART_QUIT, wx.ART_OTHER, (16,16))
